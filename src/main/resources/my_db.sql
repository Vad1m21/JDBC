...
CREATE TABLE IF NOT EXISTS `my_db`.`developers_projects` (
                                                             ...
                                                             CONSTRAINT `dev_id`
                                                                 FOREIGN KEY (`developer_id`)
                                                                     REFERENCES `my_db`.`developers` (`developers_id`)
                                                                     ON DELETE CASCADE
                                                                     ON UPDATE CASCADE,
                                                             CONSTRAINT `prj_id`
...
CREATE TABLE IF NOT EXISTS `my_db`.`developers_skills` (
                                                           ...
                                                           CONSTRAINT `skill_id`
                                                               FOREIGN KEY (`skill_id`)
                                                                   REFERENCES `my_db`.`Skills` (`Skills_id`)
                                                                   ON DELETE CASCADE
                                                                   ON UPDATE CASCADE)
    ENGINE = InnoDB;
...
INSERT INTO `my_db`.`customers` (`customer_id`, `name`, `email`) VALUES ('1', 'Xander', 'xanderTTT@gmail.com');
INSERT INTO `my_db`.`customers` (`customer_id`, `name`, `email`) VALUES ('2', 'Liza', 'li.za@mail.ru');
INSERT INTO `my_db`.`customers` (`customer_id`, `name`, `email`) VALUES ('3', 'Sasha', 'SS@gmail.com');
INSERT INTO `my_db`.`customers` (`customer_id`, `name`, `email`) VALUES ('4', 'Masha', 'MASHA1@gmail.com');


INSERT INTO `my_db`.`developers` (`developers_id`, `name`, `gender`, `age`) VALUES ('1', 'Vadim', 'male', '21');
INSERT INTO `my_db`.`developers` (`developers_id`, `name`, `gender`, `age`) VALUES ('2', 'Sasha', 'male', '25');
INSERT INTO `my_db`.`developers` (`developers_id`, `name`, `gender`, `age`) VALUES ('3', 'Masha', 'female', '19');
INSERT INTO `my_db`.`developers` (`developers_id`, `name`, `gender`, `age`) VALUES ('4', 'Katya', 'female', '26');
INSERT INTO `my_db`.`developers` (`developers_id`, `name`, `gender`, `age`) VALUES ('5', 'Vasya', 'male', '24');
...
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('1', 'Java', 'MIDDLE');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('2', 'Java', 'JUNIOR');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('3', 'C++', 'SENIOR');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('4', 'C++', 'JUNIOR');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('5', 'JS', 'MIDDLE');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('6', 'JS', 'SENIOR');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('7', 'Kotlin', 'MIDDLE');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('8', 'C#', 'SENIOR');
INSERT INTO `my_db`.`skills` (`Skills_id`, `name`, `level`) VALUES ('9', 'C#', 'JUNIOR');
...
UPDATE `my_db`.`developers` SET `salary` = '80000' WHERE (`developers_id` = '1');
UPDATE `my_db`.`developers` SET `salary` = '90000' WHERE (`developers_id` = '2');
UPDATE `my_db`.`developers` SET `salary` = '65000' WHERE (`developers_id` = '3');
UPDATE `my_db`.`developers` SET `salary` = '45000' WHERE (`developers_id` = '4');
UPDATE `my_db`.`developers` SET `salary` = '30000' WHERE (`developers_id` = '5');
